            ...
            <div class="platforms__listOfPlaforms">
                ...
                <div class="listOfPlaforms-item _anim-items _anim-no-hide">
                    ...
                    <div class="listOfPlaforms-item__information">
                        ...
                        <div class="listOfPlaforms-item__information-link">
                            <a class="downloadable-icon" href="#"><?php the_field('trade_group_text10'); ?> <span style="font-weight: bold;"><?php the_field('trade_group_text11'); ?></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="listOfPlaforms-item _anim-items _anim-no-hide">
                    ...
                    <div class="listOfPlaforms-item__information">
                        ...
                        <div class="listOfPlaforms-item__information-links">
                            <div class="listOfPlaforms-item__information-link">
                                <a class="downloadable-icon" href="#"><?php the_field('trade_group_text14'); ?><span style="font-weight: bold;"><?php the_field('trade_group_text15'); ?></span></a>
                            </div>

                            <div class="listOfPlaforms-item__information-link">
                                <a class="downloadable-icon" href="#"><?php the_field('trade_group_text16'); ?><span style="font-weight: bold;"><?php the_field('trade_group_text17'); ?></span></a>
                            </div>
                        </div>
                    </div>
                </div>
